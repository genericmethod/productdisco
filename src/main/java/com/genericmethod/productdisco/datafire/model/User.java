...
public class User {
     ...
     */
    public User(Integer id, String name, String headline, String createdAt, String username, String twitterUsername, String websiteUrl, ImageUrl imageUrl, String profileUrl) {
        this.id = id;
        this.name = name;
